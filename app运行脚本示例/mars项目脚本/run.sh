...
docker rmi ip:5000/mars-service-redis-provider:v1.0.0 
...
docker rmi ip:5000/mars-service-gateway:v1.0.0   
...
docker rmi ip:5000/mars-service-alioss:v1.0.0 
...
docker rmi ip:5000/mars-server-service-admin-provider:v1.0.0  
...
docker rmi ip:5000/mars-service-sso:v1.0.0      
...
docker rmi ip:5000/mars-server-service-pay-provider:v1.0.0 
...
docker rmi ip:5000/mars-server-service-order-provider:v1.0.0      
...
docker rmi ip:5000/mars-server-service-shop-provider:v1.0.0   
...
docker rmi ip:5000/mars-server-service-user-provider:v1.0.0  
...
docker rmi ip:5000/mars-server-service-admin-consumer:v1.0.0  
...
docker rmi ip:5000/mars-server-service-order-consumer:v1.0.0   
...
docker rmi ip:5000/mars-server-service-shop-consumer:v1.0.0   
...
docker rmi ip:5000/mars-server-service-user-consumer:v1.0.0  
...
docker rmi ip:5000/mars-server-service-pay-consumer:v1.0.0 
